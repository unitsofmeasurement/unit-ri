...
import static tec.uom.ri.format.UCUMFormat.Variant.*;
import static tec.uom.ri.util.SI.KILOGRAM;
import static tec.uom.ri.util.SI.METRE;
import static tec.uom.ri.util.SI.MINUTE;
import static tec.uom.ri.util.SI.SECOND;
